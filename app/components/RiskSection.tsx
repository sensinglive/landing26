...
export default function RiskSection() {
  ...
  return (
    <section ref={ref} className="px-20 py-20">
      <div className="flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="reveal font-sans text-base font-normal leading-[1.6] text-text-secondary max-w-[700px]">
        ...
        <div className="flex flex-col stagger">
          ...
          {risks.map((risk) => (
            <div key={risk.title}>
              <div className="reveal flex flex-col gap-2 py-6">
                <h3 className="font-mono text-xl font-extralight text-text-primary">
                  {risk.title}
                </h3>
                <p className="font-sans text-[15px] font-normal leading-[1.6] text-text-secondary max-w-[700px]">
                  {risk.desc}
                </p>
              </div>
              <div className="reveal h-px bg-divider" />
