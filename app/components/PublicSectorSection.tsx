...
export default function PublicSectorSection() {
  ...
  return (
    <section ref={ref} className="bg-bg-dark px-5 md:px-8 lg:px-20 py-12 lg:py-20">
      <div className="flex flex-col gap-8 md:gap-12 lg:gap-16">
        ...
        <h2 className="reveal font-mono text-[36px] md:text-[56px] lg:text-[72px] font-bold leading-[1.05] lg:leading-[0.95] text-white">
          Ideal para
          <br />
          Prefeituras e
          <br />
        ...
        <p className="reveal font-sans text-sm md:text-base font-normal leading-[1.6] text-white/60 max-w-full md:max-w-[600px]">
        ...
        <div className="flex flex-col stagger">
          {features.map((feat) => (
            <div
              key={feat.num}
              className="reveal flex flex-col gap-2 md:flex-row md:items-center md:justify-between py-4 md:py-6 border-t border-white/10 last:border-b"
            >
              <span className="font-mono text-xs font-extralight text-white/25">
                {feat.num}
              </span>
              <h3 className="font-mono text-base md:text-lg lg:text-xl font-extralight text-white">
                {feat.title}
              </h3>
              <p className="font-sans text-sm font-normal text-white/50 max-w-full md:max-w-[400px]">
                {feat.desc}
              </p>
            </div>
          ))}
